...
# ===============================================================
# Launch Geth + Lighthouse with Beacon Chain (Merge-ready) Setup
# ===============================================================
...
GETH_CHAIN="mainnet"
GETH_NODE_TYPE="full"  # or "archive"
...
if [ "$GETH_NODE_TYPE" = "archive" ]; then
  GETH_CMD+=(--syncmode=snap --gcmode=archive)
else
  GETH_CMD+=(--syncmode=snap --gcmode=full)
fi
